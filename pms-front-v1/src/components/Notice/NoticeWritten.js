    ...
    return(
        <S.MainWrittenWrapper>
            ...
            <S.MainWrittenItemWrapper>
                ...
                <S.CommentWrapper>
                    <S.CommentTitle><h3>댓글</h3>&nbsp;<div className="commentAmount">2개</div>
                    </S.CommentTitle>
                    <S.CommentContent>
            ...
            <S.BottomItemWrapper>
                 <S.ItemWrapper>
                     <S.ItemW>
                         <diV className="title">등교수업(원격수업) 변경 안내 <S.NewItem>NEW</S.NewItem></diV>
                        <div className="writer">이**</div>
                        <div className="day">2019-12-31</div>
                     </S.ItemW>
                     <S.ItemW>
                        <div className="title">청소년 도박용어 바로알기 <S.NewItem>NEW</S.NewItem></div>
                        <div className="writer">이**</div>
                        <div className="day">2019-12-31</div>
                    </S.ItemW>
                    <S.ItemW>
